...
4. Select a results tab:
   ...
   - **Active Position** shows positions. Use **Open**, **Not redeemed**, **Redeemed**, **Loss**, or **Sold** to choose their status, and **Single** or **Combo** to filter their type. Click a position's market cell to expand its details.
